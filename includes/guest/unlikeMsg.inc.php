...
//     $user_id = $_SESSION['userId'];
// } else {
//     $user_id = $_SESSION['guest_username'];
// }
...
$userMsgsLikesArray = changeStringArrToIntArr($result['likeMsgs']);
$newUserMsgsLikesArray = removeLikeToUser($userMsgsLikesArray, $msg_id);
if (empty($newUserMsgsLikesArray)) {
    $userMsgsLikesString = '';
} else {
    $userMsgsLikesString = changeIntArrToString($newUserMsgsLikesArray);
}
